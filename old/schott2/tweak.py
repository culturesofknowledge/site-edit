...
Run from "Database Tweak" folder with command: python -m schott2.tweak

"""

#csv_file = "schott2/Schott_UPLOAD_Details_2016.4.27.csv"
csv_file = "schott2/Missing_Schott_UPLOADS_2016.5.4a.csv"
resource_url = "https://databank.ora.ox.ac.uk/emlo/datasets/Schott/"
...
#
# 	# Get work
# 	work = tweaker.get_work_from_iwork_id( csv_row["id_column"] )
#
# 	# Get relationships
...
for csv_row in csv_rows:
	...
	# Create resource
	resource = {
		"name": csv_row[description_column],
		"url": resource_url + csv_row[file_column]
	}
