...
define( 'PERCENT_SIGN', '%' );  # for use in writing all help to script - add SCCS header at top.

define( 'PRODUCE_MANUAL_FROM_COMMANDLINE', 'produce_manual.php' );  # script used to produce manual from command line
