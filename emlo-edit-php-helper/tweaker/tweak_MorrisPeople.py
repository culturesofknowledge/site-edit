...
COL_SYN="Synonyms  (separated by semi-colon which should place them all on a separate line in EMLO)"
COL_OCC="Occupations, role, titles (separated by semi-colon which should place them all on a separate line in EMLO)"
COL_GEND="GENDER"
...
def main() :
	...
	works = []
        ...
        csv_rows = tweaker.get_csv_data("resources/Morris_PeopMent_UPLOAD_2019.12.11.csv")
